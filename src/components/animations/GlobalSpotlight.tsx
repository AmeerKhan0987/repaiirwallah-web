...
const DEFAULT_GLOW_COLOR = '249, 115, 22'; // orange-500
...
export const GlobalSpotlight = ({
  sectionRef,
  cardSelector = '.particle-container',
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      sectionRef.current?.querySelectorAll(cardSelector).forEach(card => {
        (card as HTMLElement).style.setProperty('--glow-intensity', '0');
      });
  ...
  }, [sectionRef, cardSelector, spotlightRadius, glowColor]);
